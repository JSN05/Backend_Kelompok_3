    ...
    <form method="POST" action="{{ route('password.reset.with.pin') }}">
        ...
        <div class="mt-4 relative">
            ...
            <div class="relative">
                ...
                <button type="button" onclick="togglePasswordVisibility('new_password')" class="absolute inset-y-0 right-0 pr-3 flex items-center text-sm leading-5" tabindex="-1">
        ...
        <div class="mt-4 relative">
            ...
            <div class="relative">
                ...
                <button type="button" onclick="togglePasswordVisibility('new_password_confirmation')" class="absolute inset-y-0 right-0 pr-3 flex items-center text-sm leading-5" tabindex="-1">
